  ...
  render() {
    return (
      ...
      <div className="wholeForm">
        ...
        <img className="proPic" src="https://res.cloudinary.com/dz1dbcszc/image/upload/r_30/a_360/v1547583518/img_0552_1.jpg" alt="picture" />
        </div>
        <div className="Links">
        <img className="logos" onClick={()=>window.open("https://www.linkedin.com/in/tyler-soo-hoo-937328125/")}width="40px" height="40px" src="https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png" alt="linkedIn" />
